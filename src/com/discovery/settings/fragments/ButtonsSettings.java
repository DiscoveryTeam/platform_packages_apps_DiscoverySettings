...
public class ButtonsSettings extends SettingsPreferenceFragment implements OnPreferenceChangeListener {
    ...
    private static final String KEY_APP_SWITCH_PRESS = "hardware_keys_back_press";
    private static final String KEY_APP_SWITCH_LONG_PRESS = "hardware_keys_back_long_press";
    private static final String KEY_APP_SWITCH_DOUBLE_TAP = "hardware_keys_back_double_tap";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (hasHomeKey) {
            ...
            if (defaultHomeLongPressAction < ACTION_NOTHING ||
                    defaultHomeLongPressAction > KEY_ACTION_BACK) {
            ...
            if (defaultHomeDoubleTapAction < ACTION_NOTHING ||
                    defaultHomeDoubleTapAction > KEY_ACTION_BACK) {
        ...
        if (hasMenuKey) {
            ...
            if (defaultMenuLongPressAction < ACTION_NOTHING ||
                    defaultMenuLongPressAction > KEY_ACTION_BACK) {
            ...
            if (defaultDoubleTapMenuAction < ACTION_NOTHING ||
                    defaultDoubleTapMenuAction > KEY_ACTION_BACK) {
        ...
        if (hasBackKey) {
            ...
            if (defaultBackLongPressAction < ACTION_NOTHING ||
                    defaultBackLongPressAction > KEY_ACTION_BACK) {
            ...
            if (defaultDoubleTapBackAction < ACTION_NOTHING ||
                    defaultDoubleTapBackAction > KEY_ACTION_BACK) {
        ...
        if (hasAppSwitchKey) {
            ...
            if (defaultAppSwitchLongPressAction < ACTION_NOTHING ||
                    defaultAppSwitchLongPressAction > KEY_ACTION_BACK) {
            ...
            if (defaultDoubleTapAppSwitchAction < ACTION_NOTHING ||
                    defaultDoubleTapAppSwitchAction > KEY_ACTION_BACK) {
            ...
            mAppSwitchPressAction = initActionList(KEY_BACK_PRESS, pressAppSwitchAction);

            int longPressAppSwitchAction = Settings.System.getInt(resolver,
                    Settings.System.KEY_BACK_LONG_PRESS_ACTION,
                    defaultAppSwitchLongPressAction);
            mAppSwitchLongPressAction = initActionList(KEY_BACK_LONG_PRESS, longPressAppSwitchAction);

            int doubleTapAppSwitchAction = Settings.System.getInt(resolver,
                    Settings.System.KEY_BACK_DOUBLE_TAP_ACTION,
                    defaultDoubleTapAppSwitchAction);
            mAppSwitchDoubleTapAction = initActionList(KEY_BACK_DOUBLE_TAP, doubleTapAppSwitchAction);
    ...
    public boolean onPreferenceChange(Preference preference, Object objValue) {
        if (preference == mTorchPowerButton) {
            ...
            handleActionListChange(mBackLongPressAction, objValue,
                    Settings.System.KEY_BACK_PRESS_ACTION);
            return true;
            ...
            handleActionListChange(mAppSwitchPressAction, objValue,
                    Settings.System.KEY_APP_SWITCH_PRESS_ACTION);
            return true;
        } else if (preference == mAppSwitchLongPressAction) {
