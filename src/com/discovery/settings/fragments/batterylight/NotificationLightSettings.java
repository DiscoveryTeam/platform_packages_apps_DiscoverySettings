...
package com.discovery.settings.fragments.batterylight;
...
import com.discovery.settings.preference.SystemSettingSwitchPreference;
    ...
    public Dialog onCreateDialog(int id) {
        ...
        switch (id) {
            case DIALOG_APPS:
                ...
                builder.setTitle(R.string.dialog_choose_app);
